...
class Node:
    ...
    def __init__(self):
        ...
        # deberia usarse externamente, sino que todas las tensiones deberían
...
class V_source:
    ...
    def get_current(self):
        '''
        Obtener corriente a través de la fuente
        (incógnita, sale por el nodo +).
        '''
...
class I_source:
    ...
    def get_voltage(self):
        '''
        Obtener tensión entre terminales
        de la fuente (incógnita, con + en tip).
        '''
